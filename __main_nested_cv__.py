...
def nested_kfold_runner(
    ...
    """
    test_accs = []
    skf = StratifiedKFold(n_splits=config.KFOLD_OUTER, shuffle=True, random_state=42)
...
def record_performance(model_name, k_outer, uncertainties, probs, labels, preds):
